...
<?php 
		...
		$blog = $db->fetchJone_category_blog('dmbaiviet',$sql,$p,10,true);
	...
	<div class="row">
	    <div class="col-lg-12">
	        ...
	        <ol class="breadcrumb">
	            ...
	            <li class="active">
	                <i class="fa fa-file"></i> Tên danh mục
	            </li>
	        </ol>
		        ...
		        <tbody>
		        	<?php $stt= 1; foreach ($blog as $item ): ?>
			        	<tr>
			                ...
			                <td>
			                	<a href="home.php?id_dm=<?php echo $item['id_dm'] ?>" class="btn btn-xs <?php echo $item['trangthai'] == 1 ? 'btn-info' : 'btn-default' ?>">
			                		<?php echo $item['trangthai'] == 1 ? 'Hiển thị' : 'Không' ?>
			                	</a>
			                </td>
			                <td><?php echo date("d-m-Y", strtotime($item["created_at"])) ?></td>
			                <td>
			                	<a class="btn btn-xs btn-info" href="edit.php?id_dm=<?php echo $item['id_dm'] ?>"><i class="fa fa-edit"></i>Sửa</a>
			                	<a class="btn btn-xs btn-danger" href="delete.php?id_dm=<?php echo $item['id_dm'] ?>"><i class="fa fa-times"></i>Xóa</a>
			                </td>
			            </tr>
		        	<?php $stt++ ; endforeach ?>
