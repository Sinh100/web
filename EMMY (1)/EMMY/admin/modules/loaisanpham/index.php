...
<?php 
		...
		$category = $db->fetchJone_category('loaisanpham',$sql,$p,10,true);
		        ...
		        <tbody>
		        	<?php $stt= 1; foreach ($category as $item ): ?>
			        	<tr>
			                ...
			                <td>
			                	<a class="btn btn-xs btn-info" href="edit.php?id_loai=<?php echo $item['id_loai'] ?>"><i class="fa fa-edit"></i>Sửa</a>
			                	<a class="btn btn-xs btn-danger" href="delete.php?id_loai=<?php echo $item['id_loai'] ?>"><i class="fa fa-times"></i>Xóa</a>
			                </td>
			            </tr>
		        	<?php $stt++ ; endforeach ?>
